...
import { Calendar, Users, Focus, BookOpen, ArrowRight, Star, CheckCircle } from 'lucide-react'
...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description: 'Upload syllabi and automatically populate your calendar with assignments and exams',
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
      delay: 'delay-100'
    },
    {
      ...
      description: 'Collaborate with classmates on group projects with task management and file sharing',
    ...
    },
    {
      icon: Focus,
      title: 'Focus Mode',
      description: 'Block distracting websites and track study time for better productivity',
    ...
    },
    {
      ...
      description: 'Organize all your courses, assignments, and study materials in one place',
  ...
  const benefits = [
    ...
    'Collaborate seamlessly with classmates',
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className={`text-center glass dark:glass-dark rounded-3xl p-12 shadow-xl animate-swipe-up`} style={{ animationDelay: '1.2s' }}>
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of students who have already boosted their productivity with Zenith Study Hub.
          </p>
          <Button 
            size="lg" 
